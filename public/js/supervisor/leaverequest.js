...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Remove required attributes from all form fields since we handle validation manually
...
if (leaveForm) {
    ...
    if (!leaveData.leaveType || !leaveData.leaveReason || !leaveData.startDate || !leaveData.endDate) {
        console.log('Validation failed:', leaveData); // Debug log
        showNotification('Please fill in all required fields', 'error');
        return;
    }
    
    console.log('Form validation passed:', leaveData); // Debug log
...
function deleteLeave(id) {
    if (confirm('Are you sure you want to delete this leave request?')) {
        ...
        form.method = 'POST';
        form.action = `/${path}/supervisor/deleteLeave/${id}`;
