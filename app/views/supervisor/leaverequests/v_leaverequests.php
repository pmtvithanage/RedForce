...
<div class="container">
    <div class="page-header">
        ...
        <button class="primary-btn create-btn" onclick="window.location.href='<?php echo URL_ROOT; ?>/supervisor/createLeaveRequest'">
...
<script>
    ...
    function viewRequest(id) {
        window.location.href = '<?php echo URL_ROOT; ?>/supervisor/viewLeaveRequest/' + id;
    }

    // Edit leave request
    function editRequest(id) {
        window.location.href = '<?php echo URL_ROOT; ?>/supervisor/editLeaveRequest/' + id;
    }
    ...
    function performDeleteRequest(id) {
        window.location.href = '<?php echo URL_ROOT; ?>/supervisor/deleteLeaveRequest/' + id;
    }
