...
.profile-role {
  ...
  <section class="card-section">
    ...
    <div class="form-and-photo">
      ...
      <!-- Profile Form -->
      <form class="application-form" id="profileForm" method="POST" action="<?php echo URL_ROOT; ?>/supervisor/editProfile" enctype="multipart/form-data">
        
        <!-- Avatar Upload Section -->
        <div class="photo-upload">
          <div class="profile-avatar-large">
            <div class="avatar-circle-large">
              <img class="profile-image" src="<?php echo URL_ROOT; ?>/uploads/applicantPhotos/<?php echo isset($data['supervisor']) ? $data['supervisor']->profile_image : 'default.png'; ?>" 
                   alt="Profile Image" 
                   id="imagePlaceholder"
                   data-default-src="<?php echo URL_ROOT; ?>/uploads/applicantPhotos/<?php echo isset($data['supervisor']) ? $data['supervisor']->profile_image : 'default.png'; ?>" />
            </div>
        ...
        <div>
          <div class="field">
            ...
            <input type="text" class="field-input" id="supervisor-name" name="name" value="<?php echo isset($data['supervisor']) ? $data['supervisor']->name : ''; ?>" placeholder="Enter your name">
            <span class="form-input-error" id="nameError"><?php echo isset($data['name_err']) ? $data['name_err'] : ''; ?></span>
          </div>

          <div class="field">
            <div class="field-label">Phone Number:</div>
            <input type="tel" class="field-input" id="phone" name="phone_number" value="<?php echo isset($data['supervisor']) ? $data['supervisor']->phone_number : ''; ?>" placeholder="Enter phone number">
            <span class="form-input-error" id="phoneError"><?php echo isset($data['phone_number_err']) ? $data['phone_number_err'] : ''; ?></span>
          </div>

          <div class="field">
            <div class="field-label">Email Address:</div>
            <input type="email" class="field-input" id="email" name="email" value="<?php echo isset($data['supervisor']) ? $data['supervisor']->email : ''; ?>" placeholder="Enter email address">
