...
<button class="tertiary-btn" style="display:flex; width:100px; margin: 20px;align-items:center;" onclick="window.location.href='<?php echo URL_ROOT; ?>/supervisor/incidents'"> 
...
<main class="page">
  <section class="card-section">
    ...
    <form class="application-form" method="POST" action="<?php echo URL_ROOT; ?>/supervisor/createIncident" id="incidentForm" enctype="multipart/form-data" onsubmit="return validateForm(event)">
