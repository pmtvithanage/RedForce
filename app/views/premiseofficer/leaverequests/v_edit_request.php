...
<main class="page">
    <form class="form-and-preview" action="<?php echo URL_ROOT; ?>/premiseOfficer/editLeaveRequest/<?php echo $data['leaveRequest']->id; ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="application-form" style="flex: 1 1 100%; max-width: 800px; margin: 0 auto;">
            ...
            <div class="form-actions">
                <button type="button" class="btn btn-light" onclick="window.location.href='<?php echo URL_ROOT; ?>/premiseOfficer/leaverequests'">Cancel</button>
