...
<div class="back-btn-container" style="margin: 20px;">
    <button class="tertiary-btn" style="display:flex; width:100px; align-items:center;" onclick="window.location.href='<?php echo URL_ROOT; ?>/premiseOfficer/leaverequests'"> 
    ...
    <div class="details-card">
        ...
        <div class="card-body">
            ...
            <div class="action-buttons">
                <button class="btn btn-back" onclick="window.location.href='<?php echo URL_ROOT; ?>/premiseOfficer/leaverequests'">
                    <span class="material-symbols-outlined">arrow_back</span>
                    Back to List
                </button>
                <?php if ($data['leaveRequest']->status == 'Pending'): ?>
                <button class="btn btn-edit" onclick="window.location.href='<?php echo URL_ROOT; ?>/premiseOfficer/editLeaveRequest/<?php echo $data['leaveRequest']->id; ?>'">
...
function performDelete() {
    window.location.href = '<?php echo URL_ROOT; ?>/premiseOfficer/deleteLeaveRequest/<?php echo $data['leaveRequest']->id; ?>';
}
