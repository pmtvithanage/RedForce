...
<div class="container">
    <div class="page-header">
        ...
        <button class="primary-btn create-btn" onclick="window.location.href='<?php echo URL_ROOT; ?>/premiseOfficer/createLeaveRequest'">
...
<script>
    ...
    function viewRequest(id) {
        window.location.href = '<?php echo URL_ROOT; ?>/premiseOfficer/viewLeaveRequest/' + id;
    }

    // Edit leave request
    function editRequest(id) {
        window.location.href = '<?php echo URL_ROOT; ?>/premiseOfficer/editLeaveRequest/' + id;
    }
    ...
    function performDeleteRequest(id) {
        window.location.href = '<?php echo URL_ROOT; ?>/premiseofficer/deleteLeaveRequest/' + id;
    }
