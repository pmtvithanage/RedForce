...
<main class="page">
    <form class="form-and-preview" action="<?php echo URL_ROOT; ?>/mobilerider/editLeaveRequest/<?php echo $data['leaveRequest']->id; ?>" method="POST" enctype="multipart/form-data">
