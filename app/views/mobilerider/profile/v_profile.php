        ...
        <div class="profile-grid" style="margin-top:80px;">
                ...
                <div class="card-body">
                    <div class="profile-avatar-large">
                        <div class="avatar-circle-large">
                            <img class="profile-image" src="<?php echo URL_ROOT; ?>/uploads/applicantPhotos/<?php echo $data['mobile_rider']->profile_image; ?>" alt="Profile Image"> 
                        </div>

                    </div>
                    <div class="profile-name">
                        <?php echo $data['mobile_rider']->name; ?>
                    </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    ...
                    <button class="action-btn" onclick="window.location.href='<?php echo URL_ROOT; ?>/MobileRider/editProfile'">
                ...
                <div class="card-body">
                    <div class="info-row">
                        ...
                        <div class="info-details">
                            ...
                            <div class="info-value"><?php echo $data['mobile_rider']->phone_number; ?></div>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-details">
                            ...
                            <div class="info-value"><?php echo $data['mobile_rider']->email; ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="security-card">
                ...
                <div class="card-body">
                    <div class="security-item">
                        ...
                        <button  class="btn-primary" style="border: none; cursor: pointer;" onclick="window.location.href='<?php echo URL_ROOT; ?>/MobileRider/editProfile?show=password'">
                            Change Password
                        </button>
                    </div>
                </div>
