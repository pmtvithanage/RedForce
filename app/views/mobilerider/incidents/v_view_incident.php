...
<div class="incident-detail-page">
  ...
  <div class="detail-card">
    ...
    <div class="timeline-section">
      ...
      $completedStages = 1; // Reported is always completed
      $hasReviews = !empty($data['reviews']) && count($data['reviews']) > 0;
      $isUnderReview = $hasReviews || (isset($incident->status) && $incident->status != 'Pending');
      if ($isUnderReview) $completedStages++;
      if (isset($incident->status) && $incident->status == 'In Progress') $completedStages++;
      if (isset($incident->status) && ($incident->status == 'Resolved' || $incident->status == 'Closed')) $completedStages++;
      ...
      <div class="timeline-container">
        ...
        <div class="timeline-items">
          ...
          ?>
          <div class="timeline-item <?php echo $isUnderReview ? 'completed' : 'pending'; ?>">
            <div class="timeline-circle">
              ...
              <div class="timeline-tooltip">
                ...
                <?php else: ?>
                  <div class="tooltip-detail">Status: <?php echo $incident->status ?? 'Pending'; ?></div>
                  <?php if(isset($incident->status) && $incident->status != 'Pending'): ?>
            ...
            <div class="timeline-date">
              <?php echo $isUnderReview ? date('M d, Y', strtotime($reviewDate)) : 'Pending'; ?>
            </div>
          </div>

          <!-- In Progress -->
          <div class="timeline-item <?php echo (isset($incident->status) && $incident->status == 'In Progress') ? 'completed' : 'pending'; ?>">
            <div class="timeline-circle">
            ...
            <div class="timeline-date">
              <?php echo (isset($incident->status) && $incident->status == 'In Progress') ? date('M d, Y', strtotime($incident->updated_at)) : 'Pending'; ?>
            </div>
          </div>

          <!-- Resolved -->
          <div class="timeline-item <?php echo (isset($incident->status) && ($incident->status == 'Resolved' || $incident->status == 'Closed')) ? 'completed' : 'pending'; ?>">
            <div class="timeline-circle">
              <span class="material-symbols-outlined">check_circle</span>
              <div class="timeline-tooltip">
