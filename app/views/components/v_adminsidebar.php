...
<div class="app">
      <aside class="sidebar" aria-label="Primary">
        ...
        <nav class="menu">
          ...
          <a class="menu-item <?php echo (isset($data['title']) && $data['title'] === 'Salary') ? 'is-active' : ''; ?>" href="<?php echo URL_ROOT; ?>/admin/salary"><span class="icon"></span><span class="material-symbols-outlined">payments</span><span class="label">Salary</span></a>
          ...
          <a class="menu-item <?php echo (isset($data['title']) && $data['title'] === 'Settings') ? 'is-active' : ''; ?>" href="<?php echo URL_ROOT; ?>/admin/settings"><span class="icon"></span><span class="material-symbols-outlined">settings</span><span class="label">Settings</span></a>
        </nav>
      </aside>
