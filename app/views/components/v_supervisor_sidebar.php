...
<div class="app">
    <aside class="sidebar" aria-label="Primary">
        ...
        <div class="user-card">
            ...
            <a class="menu-item <?php echo ($data['title'] === 'Equipment Requests') ? 'is-active' : ''; ?>" href="<?php echo URL_ROOT; ?>/supervisor/equipmentRequests"><span class="icon"></span><span class="material-symbols-outlined">inventory_2</span><span class="label">Equipment Requests</span></a>
