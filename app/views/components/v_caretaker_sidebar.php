...
if (isset($_SESSION['user_userID'])) {
    ...
    require_once APP_ROOT . '/models/M_caretaker.php';
    $notificationModel = new M_notifications();
    $caretakerModel = new M_caretaker();
    $notifications = $notificationModel->getNotifications($_SESSION['user_id']);
    
    // Fetch current user's profile image
    $currentUser = $caretakerModel->getCaretakerById($_SESSION['user_userID']);
...
<div class="app">
  ...
  <div class="notification-dropdown" id="notificationDropdown" hidden>
    ...
    <div class="notification-footer">
      <a href="<?php echo URL_ROOT; ?>/caretaker/notifications" class="btn-view-all">View All Notifications</a>
    </div>
  </div>
