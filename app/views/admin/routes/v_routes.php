...
<style>
  ...
  .stats-container .stat-card .stat-icon.total {
    color: #1976d2 !important;
  }

  .stats-container .stat-card .stat-icon.paid {
    color: #2e7d32 !important;
  }

  .stats-container .stat-card .stat-icon.pending {
    color: #f57c00 !important;
  }

  .stats-container .stat-card .stat-icon.overdue {
