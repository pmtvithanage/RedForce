    ...
    <div class="filter-container" id="filterContainer">
      ...
      <div class="filter-dropdown" id="filterDropdown">
          ...
          <button class="filter-option" 
                  data-value="<?php echo URL_ROOT; ?>/admin/rejected_officer_applications/<?php echo $key; ?>"
    ...
    <div class="content-container">
        ...
        <div class="profile-card">
            ...
            <div class="card-footer">
                <a href="<?php echo URL_ROOT; ?>/admin/deleteOfficerApplication/<?php echo $officer -> id?>" class="btn-primary primary-btn" id="editClientBtn">
                    Delete
                </a>
