...
<div class="main-content">
    ...
    <select
        ...
        <option value="po">Premise Officer</option>
        <option value="ct">Care Taker</option>
        <option value="mr">Mobile Rider</option>
    </select>
    ...
    (function () {
        ...
        const applyRoleFilter = () => {
            ...
            cards.forEach((card) => {
                ...
                const showCard = selectedRole === 'all' || role === selectedRole;
