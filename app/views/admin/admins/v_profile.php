        ...
        <div class="profile-grid" style="margin-top:80px;">
            ...
            <div class="info-card">
                <div class="card-header">
                    ...
                    <button class="action-btn" onclick="window.location.href='<?php echo URL_ROOT; ?>/admin/editProfile'">
            ...
            <div class="security-card">
                ...
                <div class="card-body">
                    <div class="security-item">
                        ...
                        <button  class="btn-primary" style="border: none; cursor: pointer;" onclick="window.location.href='<?php echo URL_ROOT; ?>/admin/editProfile?show=password'">
                            Change Password
                        </button>
                    </div>
                </div>
