...
.form-input-error {
  ...
  <section class="card-section">
    ...
    <div class="form-and-photo">
      ...
      <!-- Company Info Form -->
      <form class="application-form" id="serviceForm" method="POST" action="<?php echo URL_ROOT; ?>/admin/edit_profile/" enctype="multipart/form-data">
        <!-- Logo Upload Section -->
        <div class="photo-upload">
          
        <img class="imagePlaceholder" src="<?php echo URL_ROOT; ?>/uploads/image/<?php echo $data['image_name']; ?>" 
         alt="Uploaded logo preview" 
         id="imagePlaceholder"
         data-default-src="<?php echo URL_ROOT; ?>/uploads/image/<?php echo $data['image_name']; ?>" />
