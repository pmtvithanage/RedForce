...
<div class="main-content">
    <div class="tabs">
        ...
        <button class="tab primary-btn" onclick="window.location.href='<?php echo URL_ROOT; ?>/admin/accepted'">Approved Requests</button>
    ...
    <div class="content-container">
        ...
        <div class="profile-card">
            ...
            <div class="card-footer">
                ...
                <div class="btn-secondary secondary-btn">
                    <p style="margin: 0;">
                        Approved by: <strong><?php echo $clients->approved_by_username?></strong> 
                        <span style="color: #6c757d; margin-left: 15px;"><?php echo time_convert($clients->approved_time)?></span>
                    </p>
                </div>
            </div>
        </div>
