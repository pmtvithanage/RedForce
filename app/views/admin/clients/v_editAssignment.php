    ...
    <div class="form-container">
        <div class="form-card">
            <div class="form-header">
                <h1 class="form-title">Edit Duty Point Assignment</h1>
                <p class="form-subtitle">Update duty point details and personnel assignments</p>
            </div>

            <form id="editDutyPointForm">
                <!-- Current Assignment Info -->
                <div class="current-assignments">
                    <h4>Current Assignment Details</h4>
                    <div class="assignment-item">
                        <span><strong>Location:</strong> Main Entrance</span>
                        <span class="duty-status status-active">Active</span>
                    </div>
                    <div class="assignment-item">
                        <span><strong>Last Updated:</strong> 2024-01-15 14:30</span>
                        <span><strong>By:</strong> Admin User</span>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="location" name="location" class="form-input" value="Main Entrance" placeholder="e.g., Main Entrance, Parking Area" required>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="description" name="description" class="form-textarea" placeholder="Brief description of the duty point and responsibilities...">Primary security checkpoint for main building entrance. Responsible for access control and visitor management.</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="shift-section">
                        ...
                        <div class="form-group">
                            ...
                            <div class="officer-list" id="dayOfficersList">
                                <!-- Pre-filled officer items -->
                                <div class="officer-item">
                                    <img src="<?= URL_ROOT ?>/img/avatar2.jpg" alt="Officer" class="officer-avatar">
                                    <div class="officer-details" style="flex: 1;">
                                        <select name="day_officers[]" class="form-select" required>
                                            <option value="">Select Officer</option>
                                            <option value="7" selected>Michael Brown</option>
                                ...
                                <div class="officer-item">
                                    <img src="<?= URL_ROOT ?>/img/avatar3.jpg" alt="Officer" class="officer-avatar">
                                    <div class="officer-details" style="flex: 1;">
                                        <select name="day_officers[]" class="form-select" required>
                                            <option value="">Select Officer</option>
                                            <option value="7">Michael Brown</option>
                                            <option value="8">Jennifer Wilson</option>
                                            <option value="9" selected>Sarah Johnson</option>
                                            <option value="10">Thomas White</option>
                                        </select>
                                    </div>
                                    <button type="button" class="tertiary-btn" onclick="this.parentElement.remove()" style="color: #dc2626;">
                    ...
                    <div class="shift-section">
                        ...
                        <div class="form-group supervisor-select">
                            ...
                            <select id="nightSupervisor" name="nightSupervisor" class="form-select" required>
                                ...
                                <option value="5" selected>David Miller</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="officer-list" id="nightOfficersList">
                                <!-- Pre-filled officer items -->
                                <div class="officer-item">
                                    <img src="<?= URL_ROOT ?>/img/avatar5.jpg" alt="Officer" class="officer-avatar">
                                    <div class="officer-details" style="flex: 1;">
                                        <select name="night_officers[]" class="form-select" required>
                                            <option value="">Select Officer</option>
                                            <option value="7">Michael Brown</option>
                                            <option value="8" selected>Jennifer Wilson</option>
                                            <option value="9">James Anderson</option>
                                            <option value="10">Thomas White</option>
                                        </select>
                                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="equipment" name="equipment" class="form-input" value="Radio, Flashlight, Vest, Access Cards" placeholder="e.g., Radio, Flashlight, Vest">
                        </div>
...
<script>
    let officerCounter = { day: 2, night: 1 };
    ...
    function confirmDelete() {
        if (confirm('Are you sure you want to delete this duty point assignment? This action cannot be undone.')) {
            // Here you would typically send delete request to server
            console.log('Assignment deleted');
            alert('Duty point assignment deleted successfully!');
            window.location.href = '<?= URL_ROOT ?>/admin/duty-points';
        }
    }

    // Form submission handler
    document.getElementById('editDutyPointForm').addEventListener('submit', function(e) {
        e.preventDefault();
        ...
        // Check if at least one officer is assigned to each shift
        const dayOfficers = document.querySelectorAll('select[name="day_officers[]"]');
        const nightOfficers = document.querySelectorAll('select[name="night_officers[]"]');
        
        let dayOfficersCount = 0;
        let nightOfficersCount = 0;
        
        dayOfficers.forEach(select => {
            if (select.value) dayOfficersCount++;
        });
        
        nightOfficers.forEach(select => {
            if (select.value) nightOfficersCount++;
        });
        
        if (dayOfficersCount === 0 || nightOfficersCount === 0) {
            alert('Please assign at least one officer to each shift.');
            return;
        }

        // Here you would typically send the form data to the server
        console.log('Form submitted successfully!');
        alert('Duty point assignment updated successfully!');
