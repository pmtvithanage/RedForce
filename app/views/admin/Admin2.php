...
<div class="main-content">
    ...
    <div style="display:flex; align-items:center; gap:12px; margin-left: 8px; padding: 8px 12px; border:1px solid #e5e7eb; border-radius:8px; background:#fff;">
        ...
        <label style="display:flex; align-items:center; gap:6px; font-size:13px; color:#111827;">
            <input type="checkbox" class="role-checkbox" value="po" checked>
            Premise Officer
        </label>
        <label style="display:flex; align-items:center; gap:6px; font-size:13px; color:#111827;">
            <input type="checkbox" class="role-checkbox" value="ct" checked>
            Care Taker
        </label>
        <label style="display:flex; align-items:center; gap:6px; font-size:13px; color:#111827;">
            <input type="checkbox" class="role-checkbox" value="mr" checked>
            Mobile Rider
        </label>
    </div>
...
<script>
    (function () {
        ...
        if (roleCheckboxes.length === 0 || cards.length === 0) {
            return;
        }
        ...
        const applyRoleFilter = () => {
            ...
            cards.forEach((card) => {
                ...
                card.style.display = selectedRoles.includes(role) ? '' : 'none';
            });
        };

        roleCheckboxes.forEach((checkbox) => {
            checkbox.addEventListener('change', applyRoleFilter);
        });
    })();
</script>
