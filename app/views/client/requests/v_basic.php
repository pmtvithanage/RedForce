...
<div class="main-content">
    ...
    <div class="package-detail-container">
        ...
        <div class="package-info-card">
            <div class="package-header-detail basic-header">
                <h2>Basic Package</h2>
            </div>
            ...
            <div class="package-details-section">
                ...
                <ul class="features-list">
                    <li><span class="material-icons">check_circle</span> Two trained security guards assigned for continuous coverage</li>
                    <li><span class="material-icons">check_circle</span> Day Shift: 9:00 AM ~ 5:00 PM (1 guard)</li>
                    <li><span class="material-icons">check_circle</span> Night Shift: 5:00 PM ~ 1:00 AM (1 guard)</li>
        ...
        <div class="booking-form-card">
            ...
            <form method="POST" action="<?php echo URL_ROOT; ?>/client/submitPackageRequest" enctype="multipart/form-data">
                <input type="hidden" name="package_name" value="Basic Package">
                <input type="hidden" name="number_of_guards" value="2">
                <input type="hidden" name="monthly_price" value="30000">
                ...
                <div class="form-group">
                    ...
                    <div class="price-display">
                        <span class="total-price">LKR <span id="totalPrice">30,000</span>/=</span>
                        <small class="price-breakdown">LKR 30,000 × <span id="monthsDisplay">1</span> month(s)</small>
                    </div>
                </div>
...
<script>
// Price calculation for Basic Package
