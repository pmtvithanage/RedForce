...
<div class="main-content">
    ...
    <div class="package-detail-container">
        ...
        <div class="package-info-card">
            <div class="package-header-detail budget-header">
            ...
            <div class="package-details-section">
                ...
                <ul class="features-list">
                    <li><span class="material-icons">check_circle</span> Four trained security guards assigned for continuous coverage</li>
                    <li><span class="material-icons">check_circle</span> Day Shift: 9:00 AM ~ 5:00 PM (2 guards)</li>
                    <li><span class="material-icons">check_circle</span> Night Shift: 5:00 PM ~ 1:00 AM (2 guards)</li>
                    ...
                    <li><span class="material-icons">check_circle</span> Suitable for small to medium-scale properties, offices, residential sites, and construction locations</li>
                    <li><span class="material-icons">check_circle</span> Cost-effective security solution providing reliability and peace of mind</li>
                </ul>
        ...
        <div class="booking-form-card">
            ...
            <form method="POST" action="<?php echo URL_ROOT; ?>/client/submitPackageRequest" enctype="multipart/form-data">
                <input type="hidden" name="package_name" value="Budget Package">
                <input type="hidden" name="number_of_guards" value="4">
                <input type="hidden" name="monthly_price" value="56000">
                ...
                <!-- Site Address -->
                <div class="form-group">
                    <label for="site_address">Enter site address</label>
                ...
                <div class="form-group">
                    ...
                    <div class="price-display">
                        <span class="total-price">LKR <span id="totalPrice">56,000</span>/=</span>
                        <small class="price-breakdown">LKR 56,000 × <span id="monthsDisplay">1</span> month(s)</small>
                    </div>
                </div>
...
<script>
// Price calculation for Budget Package
const monthlyPrice = 56000;
