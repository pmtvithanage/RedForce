...
class Home extends Controller
{
    ...
    public function service()
    {
        try {
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                // Make sure no errors
                if (
                    empty($data['image_err']) && empty($data['company_name_err']) && empty($data['legal_company_name_err']) &&
    ...
    private function showError($title, $exception)
    {
        ...
        $isDebugMode = defined('DEBUG_MODE') ? (bool) constant('DEBUG_MODE') : false;
        ...
        $data = [
            ...
            'error_trace' => $isDebugMode ? $exception->getTraceAsString() : '',
